package com.thales.googlehashcode.common.model.genetic;

/**
 * Evaluates a candidate. During the selection phase, only the candidates with the highest score will be retained
 *
 * @param <Genotype>
