...
public class Complex {
    ...
    /**
     * Constructs a complex from a real and imaginary value
     *
     * @param real assigned to the real part of the complex number
     * @param imaginary assigned to the imaginary part of the complex number
     */
    ...
    /**
     * @return true if the complex number has no imaginary value (equals 0)
     */
